package GuessGame;
/**
 * <b>{@code GuesserGame}</b> - A simple Guesser game. where there is one guesser, three players and an umpire.
 * 
 ...
 * 
 * <p><b>{@code GuesserGame}</b> - Main class which calls the umpire object logic and its method.
